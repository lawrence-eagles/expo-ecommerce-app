...
const ProductDetailScreen = () => {
  ...
  return (
    <SafeScreen>
      ...
      >
        {/* IMAGE GALLERY */}
        {/* Note (contentOffset.x) gets how far you’ve scrolled and we
          divide by screen width to figure out which image you're on */}

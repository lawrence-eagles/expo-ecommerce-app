    ...
    <SafeScreen>
      ...
      >
              ...
              <View className="flex-row items-center">
                ...
                {setting.type === "toggle" ? (
                  <Switch
                    ...
                    // ios_backgroundColor={"#2A2A2A"} for ios false case only
                  />
                ) : (
                  <Ionicons
        ...
        <View className="px-6 pt-4">
          <Text className="text-text-primary text-lg font-bold">Account</Text>
          ...
          {accountSettings.map((setting) => (
            ...
            >
              <View className="flex-row items-center">
                ...
                <Ionicons name="chevron-forward" size={28} color={"#666666"} />
              </View>
            </TouchableOpacity>
          ))}
        </View>
